        ...
        <section className="mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-8">
                {props.members.map((member) => (
                    <div key={member.name} className={`flex w-full flex-col items-center rounded-xl bg-cBackgroundOffset p-6 text-center shadow-lg sm:w-[calc(50%-1rem)] ${isDevTeam ? "lg:w-[calc(33.333%-1rem)]" : "lg:w-[calc(33.333%-1.34rem)]"} dark:bg-mindvista-950`}>
                        <div className="mb-4 h-40 w-40 overflow-hidden rounded-full">
                            <Image src={member.image || "/team/avatarPlaceholder.png"} alt={member.name} width={500} height={500} className="h-full w-full object-cover" />
                        </div>
